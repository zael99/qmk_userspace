    ...
    #define BASE_LAYER LAYOUT_split_4x6_3 ( \
        ...
        KC_LSFT,     LGUI_T(KC_A), LALT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G,                          KC_H,       RCTL_T(KC_J), RSFT_T(KC_K), RALT_T(KC_L), RGUI_T(KC_SCLN), KC_RSFT, \
    ...
    #define SYMBOL_LAYER LAYOUT_split_4x6_3 ( \
        ...
        _______,    KC_LBRC,     KC_RBRC,     LSFT(KC_9), LSFT(KC_0), _______,                         _______,    KC_BSLS,    KC_SLSH,  S(KC_QUOTE), KC_QUOTE,    _______, \
        _______,    _______,     _______,     _______,    _______,    _______,                         _______,    _______,    _______,  _______,     _______,     _______, \
                                              _______,    _______,    _______,                         _______,    _______,    _______ \
    )
    ...
    #define MACRO_LAYER LAYOUT_split_4x6_3 ( \
        _______,   PDF(BASE),  DF(GAMING), _______,    _______,    _______,                        _______,    _______,   _______,   _______,   _______,   _______, \
